<p align="center">
  <img src="assets/banner.png" alt="Mr. FPGA Stream Deck" width="640">
</p>

<h1 align="center">Mr. FPGA Stream Deck</h1>

<p align="center">Live Mr. FPGA status, system health, RetroAchievements, and one-press controls on your Stream Deck.</p>

<p align="center">
  <a href="https://github.com/hudsonbrendon/mr-fpga-stream-deck/actions/workflows/tests.yml"><img src="https://github.com/hudsonbrendon/mr-fpga-stream-deck/actions/workflows/tests.yml/badge.svg" alt="Tests"></a>
  <a href="https://hudsonbrendon.github.io/mr-fpga-stream-deck/"><img src="https://img.shields.io/badge/docs-mkdocs--material-blue" alt="Docs"></a>
  <a href="LICENSE"><img src="https://img.shields.io/badge/License-MIT-yellow.svg" alt="License: MIT"></a>
  <img src="https://img.shields.io/badge/Stream%20Deck-SDK%20v2-101010" alt="Stream Deck SDK v2">
</p>

Four keys for your [Mr. FPGA](https://misterfpga.org/), powered by the
...
**`com.hudsonbrendon.mrfpga.streamDeckPlugin`** from the
[Releases](https://github.com/hudsonbrendon/mr-fpga-stream-deck/releases) page and
...
Then add the actions from the "Mr. FPGA Stream Deck" category and set your Mr. FPGA's IP in the Property
Inspector. Full guide: [docs/INSTALL.md](docs/INSTALL.md).

## 📚 Docs

Full docs at <https://hudsonbrendon.github.io/mr-fpga-stream-deck/> — see
